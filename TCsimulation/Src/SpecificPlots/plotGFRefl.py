...
if(parallel):
    if(plotR):
        ...
        for ifile in ifiles:
            ...
            pyplot.plot(data[:,0], numpy.sqrt(data[:,1]**2 + data[:,2]**2), label='R_p')
    ...
    if(plotT):
        ...
        for ifile in ifiles:
            data = numpy.loadtxt(ifile, skiprows=skipRows, delimiter = dataDelimiter) # Load file data
            pyplot.plot(data[:,0], numpy.sqrt(data[:,9]**2 + data[:,10]**2), label='T_p')
            pyplot.legend(loc='best')
    ...
    if(plotA):
        ...
        for ifile in ifiles:
            data = numpy.loadtxt(ifile, skiprows=skipRows, delimiter = dataDelimiter) # Load file data
            pyplot.plot(data[:,0], 1-numpy.sqrt(data[:,9]**2 + data[:,10]**2)-numpy.sqrt(data[:,1]**2 + data[:,2]**2), label='1-T_p-R_p')
            pyplot.legend(loc='best')
...
if(senkrecht):
    if(plotR):
        ...
        for ifile in ifiles:
            data = numpy.loadtxt(ifile, skiprows=skipRows, delimiter = dataDelimiter) # Load file data
            pyplot.plot(data[:,0], numpy.sqrt(data[:,5]**2 + data[:,6]**2), label='R_s')
            pyplot.legend(loc='best')
    ...
    if(plotT):
        ...
        for ifile in ifiles:
            data = numpy.loadtxt(ifile, skiprows=skipRows, delimiter = dataDelimiter) # Load file data
            pyplot.plot(data[:,0], numpy.sqrt(data[:,13]**2 + data[:,14]**2), label='T_s')
            pyplot.legend(loc='best')
    ...
    if(plotA):
        ...
        for ifile in ifiles:
            data = numpy.loadtxt(ifile, skiprows=skipRows, delimiter = dataDelimiter) # Load file data
            pyplot.plot(data[:,0], 1-numpy.sqrt(data[:,5]**2 + data[:,6]**2)-numpy.sqrt(data[:,13]**2 + data[:,14]**2), label='1-T_s-R_s')
            pyplot.legend(loc='best')
