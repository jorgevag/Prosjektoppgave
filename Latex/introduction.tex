...
%, in order to reduce the related CO$_2$ emmisions. 
...
Commonly, windows fall into the category of some of the least energy efficient components of a building.
...
%of the energy of the incident light that is transmitted through the window.
%In window standards the latter is the most important, as the glazing characteristics
%determines transmission of light through the window.
...
with the air tightness of the window, the most relevant technical issues regarding energy losses.
 \cite{Tarantini2011}.%(\cite{Kamalisarvestani2013}, s.354 avsnitt 2)\\
%
...
\cite{Kamalisarvestani2013}. %A lot of the information of this section is based on the article of Kamalisarvestani. Do I need to specify more credit?
