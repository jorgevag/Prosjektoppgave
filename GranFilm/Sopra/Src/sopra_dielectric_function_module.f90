...
Contains
  ...
  Subroutine SOPRA_dielectric_function_vector(arg,epsilon,material,path,arg_unit)
    ...
    select case( trim(adjustl(local_arg_unit)) )
       ! Microns
    case("microns")
       call _SOPRA_dielectric_function_wavelength_(arg,epsilon,material,path)
    case("eV")
       call _SOPRA_dielectric_function_energy_(arg,epsilon,material,path)
    case default
  ...
  Subroutine _SOPRA_dielectric_function_wavelength_(wavelength,epsilon,material,path)
    !
  ...
  End Subroutine _SOPRA_dielectric_function_wavelength_

  !
  ! -----
  ! 

  Subroutine _SOPRA_dielectric_function_energy_(energy,epsilon,material,path)
    !
    ! ---  This routne returns the SOPRA dielctric function for 
    ...
    call _SOPRA_dielectric_function_wavelength_(_eV2micron_(energy),epsilon,material,path)
    
  End Subroutine _SOPRA_dielectric_function_energy_
  ...
  Elemental Function _eV2micron_(indata) result(res)
    !
